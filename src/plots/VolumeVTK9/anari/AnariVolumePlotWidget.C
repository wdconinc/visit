...
const std::string AnariVolumePlotWidget::USD_WIDGET_KEY = "usd";
const std::string AnariVolumePlotWidget::DEFAULT_WIDGET_KEY = "default";
    ...
    , dirLineEdit(nullptr)
{
    ...
    dynamicLayoutMap[AnariVolumePlotWidget::DEFAULT_WIDGET_KEY] = widgetIndex;

    // USD Widget
    widgetIndex = dynamicLayouts->addWidget(CreateUSDWidget(bottomRows));
    dynamicLayoutMap[AnariVolumePlotWidget::USD_WIDGET_KEY] = widgetIndex;
...
AnariVolumePlotWidget::CreateUSDWidget(int &rows)
{
    ...
    connect(dirLineEdit, &QLineEdit::editingFinished, this, &AnariVolumePlotWidget::lineEditingFinished);
    ...
    connect(commitCheckBox, &QCheckBox::toggled, this, &AnariVolumePlotWidget::checkBoxToggled);
    ...
    connect(binaryCheckBox, &QCheckBox::toggled, this, &AnariVolumePlotWidget::checkBoxToggled);
    ...
    connect(materialCheckBox, &QCheckBox::toggled, this, &AnariVolumePlotWidget::checkBoxToggled);
    ...
    connect(previewCheckBox, &QCheckBox::toggled, this, &AnariVolumePlotWidget::checkBoxToggled);
    ...
    connect(mdlCheckBox, &QCheckBox::toggled, this, &AnariVolumePlotWidget::checkBoxToggled);
    ...
    connect(mdlColorCheckBox, &QCheckBox::toggled, this, &AnariVolumePlotWidget::checkBoxToggled);
    ...
    connect(displayColorCheckBox, &QCheckBox::toggled, this, &AnariVolumePlotWidget::checkBoxToggled);
...
// ****************************************************************************
// Method: AnariVolumePlotWidget::MakeWidgetFromParameterInfo
//
// Purpose:
...
QWidget *
AnariVolumePlotWidget::MakeWidgetFromParameterInfo(const AnariParameterInfo &paramInfo)
{
    ...
    switch(anariDataType)
    {
        case ANARI_INT32:
        {
            ...
            connect(spinBox, QOverload<int>::of(&QSpinBox::valueChanged),
                    this, &AnariVolumePlotWidget::spinBoxValueChanged);
        ...
        case ANARI_FLOAT32:
        {
            ...
            connect(lineEdit, &QLineEdit::editingFinished,
                    this, &AnariVolumePlotWidget::lineEditingFinished);
        ...
        case ANARI_STRING:
        {
            ...
            if(!acceptedVals.empty())
            {
                ...
                connect(comboBox, QOverload<const QString &>::of(&QComboBox::currentTextChanged),
                        this, &AnariVolumePlotWidget::comboBoxTextChanged);
        ...
        case ANARI_BOOL:
        {
            ...
            connect(checkBox, &QCheckBox::toggled,
                    this, &AnariVolumePlotWidget::checkBoxToggled);
...
// ****************************************************************************
// Method: AnariVolumePlotWidget::CreateDynamicWidget
//
// Purpose:
...
void
AnariVolumePlotWidget::CreateDynamicWidget(anari::Device anariDevice, const char *subtype, const std::string &key, bool isUSD)
{
    int stackLayoutIndex = this->dynamicLayoutMap[AnariVolumePlotWidget::DEFAULT_WIDGET_KEY];

    if(isUSD)
    {
        stackLayoutIndex = this->dynamicLayoutMap[AnariVolumePlotWidget::USD_WIDGET_KEY];
    }
    else
    {
...
// ****************************************************************************
// Method: AnariVolumePlotWidget::GetParameterInfo
//
// Purpose:
...
AnariParameterInfo
AnariVolumePlotWidget::GetParameterInfo(anari::Device device,
...
// ****************************************************************************
// Method: AnariVolumePlotWidget::UpdateRendererParameters
//
// Purpose:
...
void
AnariVolumePlotWidget::UpdateRendererParameters(const stringVector &params)
{
...
void
AnariVolumePlotWidget::UpdateUSDParameters(const stringVector &params)
{
    // TODO: Implement
...
// ****************************************************************************
// Method: AnariVolumePlotWidget::spinBoxValueChanged
//
// Purpose:
...
void AnariVolumePlotWidget::spinBoxValueChanged(int value)
{
    UpdateRenderingAttributes(false);
}

// ****************************************************************************
// Method: AnariVolumePlotWidget::lineEditingFinished
//
// Purpose:
...
void
AnariVolumePlotWidget::lineEditingFinished()
{
    UpdateRenderingAttributes(false);
}

// ****************************************************************************
// Method: AnariVolumePlotWidget::comboBoxTextChanged
//
// Purpose:
...
void
AnariVolumePlotWidget::comboBoxTextChanged(const QString &text)
{
    UpdateRenderingAttributes(false);
}

// ****************************************************************************
// Method: AnariVolumePlotWidget::checkBoxToggled
//
// Purpose:
...
void
AnariVolumePlotWidget::checkBoxToggled(bool checked)
{
    UpdateRenderingAttributes(false);
}

// ****************************************************************************
// Method: AnariVolumePlotWidget::UpdateRenderingAttributes
//
// Purpose:
...
void
AnariVolumePlotWidget::UpdateRenderingAttributes(const bool updateApply)
{
    auto widget = dynamicLayouts->currentWidget();
...
// ****************************************************************************
// Method: AnariVolumePlotWidget::ClearAnariParameterAttributes
//
// Purpose:
...
void AnariVolumePlotWidget::ClearAnariParameterAttributes()
{
    stringVector params;
    volumeAttributes->SetAnariRendererParameters(params);
    volumeAttributes->SetAnariUSDParameters(params);
